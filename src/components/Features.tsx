...
const SkeletonOne = () => {
  ...
  return (
<MagnetLines className="text-black dark:text-white"
  rows={4}
  columns={15}
  ...
  lineHeight="4vmin"
  baseAngle={0}
  style={{ margin: "20px auto" , marginTop:"5px" }}
/>
  );
};
    ...
    >
      {arr.map((_, i) => (
        <motion.div
          ...
          className="flex flex-row rounded-full bg-pulse-600 border border-pulse-600
                    dark:border-pulse-600/[0.2] p-2 items-center space-x-2 w-full h-4"
        />
      ))}
    </motion.div>
  );
...
const SkeletonFive = () => {
  ...
  return (
    ...
    >
      ...
      >
        <p className="text-xs text-neutral-500">chi</p>
  ...
  return (
    <section id="features" className="py-16 bg-white dark:bg-black">
      <div className="section-container opacity-0 animate-on-scroll">
        ...
        <h2 className="text-5xl font-display font-bold mb-16 text-black dark:text-white">
